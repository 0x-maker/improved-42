  ...
  const handleEthereumSignIn = async () => {
    if (typeof window.ethereum !== 'undefined') {
      try {
        ...
        const message = `Sign this message to prove you own the address ${address}. This won't cost you any Ether.`;
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div>
                ...
                >
                  <span className="sr-only">Sign in with Ethereum</span>
                  <svg className="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                    {/* Add Ethereum logo SVG here */}
                  </svg>
                </button>
              </div>
